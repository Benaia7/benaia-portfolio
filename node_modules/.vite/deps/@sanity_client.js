...
var UsersClient = class {
  ...
  getById(id) {
    return lastValueFrom(
      _request(__privateGet(this, _client15), __privateGet(this, _httpRequest10), {
        uri: `/users/${id}`
      })
    );
  }
...
var _clientConfig, _httpRequest11;
var _ObservableSanityClient = class _ObservableSanityClient {
  constructor(httpRequest, config2 = defaultConfig) {
    ...
    this.config(config2), __privateSet(this, _httpRequest11, httpRequest), this.assets = new ObservableAssetsClient(this, __privateGet(this, _httpRequest11)), this.datasets = new ObservableDatasetsClient(this, __privateGet(this, _httpRequest11)), this.live = new LiveClient(this), this.projects = new ObservableProjectsClient(this, __privateGet(this, _httpRequest11)), this.users = new ObservableUsersClient(this, __privateGet(this, _httpRequest11)), this.agent = {
      action: new ObservableAgentsActionClient(this, __privateGet(this, _httpRequest11))
    };
  }
  /**
   ...
   */
  clone() {
    return new _ObservableSanityClient(__privateGet(this, _httpRequest11), this.config());
  }
  config(newConfig) {
    if (newConfig === void 0)
  ...
  withConfig(newConfig) {
    ...
    return new _ObservableSanityClient(__privateGet(this, _httpRequest11), {
      ...thisConfig,
      ...newConfig,
      stega: {
        ...thisConfig.stega || {},
  ...
  getDocument(id, options) {
    return _getDocument(this, __privateGet(this, _httpRequest11), id, options);
  }
  /**
  ...
  getDocuments(ids, options) {
    return _getDocuments(this, __privateGet(this, _httpRequest11), ids, options);
  }
  create(document2, options) {
    return _create(this, __privateGet(this, _httpRequest11), document2, "create", options);
  }
  createIfNotExists(document2, options) {
    return _createIfNotExists(this, __privateGet(this, _httpRequest11), document2, options);
  }
  createOrReplace(document2, options) {
    return _createOrReplace(this, __privateGet(this, _httpRequest11), document2, options);
  }
  delete(selection, options) {
    return _delete(this, __privateGet(this, _httpRequest11), selection, options);
  }
  mutate(operations, options) {
    return _mutate(this, __privateGet(this, _httpRequest11), operations, options);
  }
  /**
  ...
  action(operations, options) {
    return _action(this, __privateGet(this, _httpRequest11), operations, options);
  }
  /**
   ...
   */
  request(options) {
    return _request(this, __privateGet(this, _httpRequest11), options);
  }
  /**
...
var _clientConfig2, _httpRequest12;
var _SanityClient = class _SanityClient {
  constructor(httpRequest, config2 = defaultConfig) {
     ...
     */
    __publicField(this, "listen", _listen);
    this.config(config2), __privateSet(this, _httpRequest12, httpRequest), this.assets = new AssetsClient(this, __privateGet(this, _httpRequest12)), this.datasets = new DatasetsClient(this, __privateGet(this, _httpRequest12)), this.live = new LiveClient(this), this.projects = new ProjectsClient(this, __privateGet(this, _httpRequest12)), this.users = new UsersClient(this, __privateGet(this, _httpRequest12)), this.agent = {
      action: new AgentActionsClient(this, __privateGet(this, _httpRequest12))
   ...
   */
  clone() {
    return new _SanityClient(__privateGet(this, _httpRequest12), this.config());
  }
  config(newConfig) {
    if (newConfig === void 0)
  ...
  withConfig(newConfig) {
    const thisConfig = this.config();
    return new _SanityClient(__privateGet(this, _httpRequest12), {
      ...thisConfig,
      ...newConfig,
      stega: {
        ...thisConfig.stega || {},
   ...
   */
  getDocument(id, options) {
    return lastValueFrom(_getDocument(this, __privateGet(this, _httpRequest12), id, options));
  }
  /**
   * Fetch multiple documents in one request.
   * Should be used sparingly - performing a query is usually a better option.
   ...
   */
  getDocuments(ids, options) {
    return lastValueFrom(_getDocuments(this, __privateGet(this, _httpRequest12), ids, options));
  }
  create(document2, options) {
    return lastValueFrom(
      _create(this, __privateGet(this, _httpRequest12), document2, "create", options)
    );
  }
  createIfNotExists(document2, options) {
    return lastValueFrom(
      _createIfNotExists(this, __privateGet(this, _httpRequest12), document2, options)
    );
  }
  createOrReplace(document2, options) {
    return lastValueFrom(
      _createOrReplace(this, __privateGet(this, _httpRequest12), document2, options)
    );
  }
  delete(selection, options) {
    return lastValueFrom(_delete(this, __privateGet(this, _httpRequest12), selection, options));
  }
  mutate(operations, options) {
    return lastValueFrom(_mutate(this, __privateGet(this, _httpRequest12), operations, options));
  }
  /**
   * Create a new buildable patch of operations to perform
   *
   ...
   */
  action(operations, options) {
    return lastValueFrom(_action(this, __privateGet(this, _httpRequest12), operations, options));
  }
  /**
   ...
   */
  request(options) {
    return lastValueFrom(_request(this, __privateGet(this, _httpRequest12), options));
  }
  /**
  ...
  dataRequest(endpoint, body, options) {
    return lastValueFrom(_dataRequest(this, __privateGet(this, _httpRequest12), endpoint, body, options));
  }
  /**
   * Get a Sanity API URL for the URI provided
   *
